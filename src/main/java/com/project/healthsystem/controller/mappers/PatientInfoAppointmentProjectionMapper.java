...
public abstract class PatientInfoAppointmentProjectionMapper {
    ...
    @Mapping(target = "responsibleProfessionalName", expression = "java(entity.getResponsibleProfessionalNameSafe())")
    @Mapping(target = "requestingProfessionalName", expression = "java(entity.getRequestingProfessionalNameSafe())")
